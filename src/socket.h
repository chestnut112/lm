...
public:
     ...
     * @param[in] address 地址
     */
    static Socket::ptr CreateTCP(arvin::Address::ptr address);

    /**
     * @brief 创建UDP Socket(满足地址类型)
     * @param[in] address 地址
     */
    static Socket::ptr CreateUDP(arvin::Address::ptr address);
...
public:
    ...
    static SSLSocket::ptr CreateTCP(arvin::Address::ptr address);
